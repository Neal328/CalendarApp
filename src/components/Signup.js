    ...
    >
      ...
      >
        <div className="text-center mb-4">
          <h2 style={{ fontWeight: 600, fontSize: 24 }}>Sign up to QuickPlan</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn btn-dark mb-3" style={{ width: "100%" }}>
            Create an Account
          </button>
          ...
          <div className="d-flex justify-content-center social-icons">
            <img
              ...
              alt="Google"
              style={{ width: 36, margin: "0 10px", cursor: "pointer" }}
            />
            <img
